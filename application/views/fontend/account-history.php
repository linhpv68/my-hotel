...
<head>
    <title>Travel Mate - Account history</title>
    <meta charset="UTF-8"/>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <p class="theme-account-history-item-price">$318.30</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="theme-account-history-type">
                    ...
                    <td>
                      <p class="theme-account-history-item-price">$188.11</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="theme-account-history-type">
                    ...
                    <td>
                      <p class="theme-account-history-item-price">$303.64</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="theme-account-history-type">
                    ...
                    <td>
                      <p class="theme-account-history-item-price">$374.36</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="theme-account-history-type">
                    ...
                    <td>
                      <p class="theme-account-history-item-price">$250.42</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="theme-account-history-type">
                    ...
                    <td>
                      <p class="theme-account-history-item-price">$299.11</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="theme-account-history-type">
                    ...
                    <td>
                      <p class="theme-account-history-item-price">$462.72</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="theme-account-history-type">
                    ...
                    <td>
                      <p class="theme-account-history-item-price">$418.57</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="theme-account-history-type">
                    ...
                    <td>
                      <p class="theme-account-history-item-price">$268.29</p>
                    </td>
                  </tr>
                  <tr>
                    <td class="theme-account-history-type">
                    ...
                    <td>
                      <p class="theme-account-history-item-price">$348.73</p>
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div class="col-md-3">
            <div class="theme-footer-section theme-footer-">
              ...
              <div class="theme-footer-brand-text">
                <p>Neque purus sollicitudin sed dui proin risus amet dignissim vivamus euismod donec potenti metus velit</p>
                <p>Habitasse vehicula semper vehicula porttitor maecenas cursus dapibus pretium hendrerit nascetur mus neque duis elementum</p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
