...
<!-- Mirrored from remtsoy.com/tf_templates/tf-bookify-demo/payment.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Jan 2019 08:10:55 GMT -->
<head>
    <title>Travel Mate - Hotel payment 1</title>
    <meta charset="UTF-8"/>
            ...
            <div class="theme-payment-page-sections">
              ...
              <div class="theme-payment-page-sections-item">
                <div class="theme-search-results-item theme-payment-page-item-thumb">
                  <h5 class="theme-search-results-item-title">Standart King Room</h5>
                  <div class="row" data-gutter="20">
                    ...
                    <div class="col-md-3 ">
                      <div class="theme-search-results-item-img-wrap">
                        <img class="theme-search-results-item-img" src="img/hotel-page/rooms/1.jpg" alt="Image Alternative text" title="Image Title"/>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-4 ">
            <div class="sticky-col">
              <div class="theme-sidebar-section _mb-10">
                ...
                <img class="theme-sidebar-section-hotel-thumbnail-img" src="img/hotel-page/sidebar/hotel-thumbnail-1.jpg" alt="Image Alternative text" title="Image Title"/>
          ...
          <div class="col-md-3">
            <div class="theme-footer-section theme-footer-">
              ...
              <div class="theme-footer-brand-text">
                <p>Lectus tristique curae venenatis facilisis parturient arcu et sociosqu accumsan scelerisque tincidunt nibh magna phasellus</p>
                <p>Accumsan auctor posuere purus egestas vivamus litora ad mauris lobortis at elementum commodo condimentum consectetur</p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
...
<!-- Mirrored from remtsoy.com/tf_templates/tf-bookify-demo/payment.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Jan 2019 08:11:06 GMT -->
</html>