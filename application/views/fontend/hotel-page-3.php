...
<!-- Mirrored from remtsoy.com/tf_templates/tf-bookify-demo/hotel-page-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Jan 2019 08:10:26 GMT -->
<head>
    <title>Travel Mate - Hotel page 3</title>
    <meta charset="UTF-8"/>
  ...
  <body class="gray">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      ...
                      <ul class="dropdown-meganav-list-items">
                        ...
                        <li>
                          <a href="search-results.php">Layout 2</a>
                        </li>
                        <li>
                    ...
                    <div class="col-md-3">
                      ...
                      <ul class="dropdown-meganav-list-items">
                        ...
                        <li>
                          <a href="hotel-page-3.php">Layout 3</a>
                        </li>
                        <li>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="navbar-nav-item-user dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a href="account-bookmarks.php">Bookmarks</a>
                  </li>
                </ul>
              </li>
            </ul>
    ...
    <div class="theme-hero-area">
      <div class="theme-hero-area-bg-wrap">
        <div class="theme-hero-area-bg theme-hero-area-bg-blur" style="background-image:url(img/hotel-page/layout-1/header-7.jpg);"></div>
        ...
        <div class="container">
          <div class="theme-item-page-header _pt-150 _pb-50 theme-item-page-header-white">
            <div class="theme-item-page-header-body">
              ...
              <h1 class="theme-item-page-header-title">Kimpton Hotel Eventi</h1>
              ...
              <ul class="theme-breadcrumbs">
                ...
                <li>
                  <p class="theme-breadcrumbs-item-title active">Kimpton Hotel Eventi</p>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="theme-page-section theme-page-section-dark theme-page-section-xl">
      <div class="container">
        <div class="row row-col-static" id="sticky-parent">
          <div class="col-md-9 ">
            <div class="row _mb-desk-60">
              <div class="col-md-6 ">
                <div class="row magnific-gallery row-col-gap" data-gutter="10">
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/2.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/2.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/3.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/3.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/4.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/4.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/5.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/5.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/6.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/6.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/7.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/7.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/8.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/8.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/9.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/9.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/10.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/10.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/11.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/11.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/12.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/12.jpg"></a>
                    </div>
                  </div>
                  <div class="col-xs-3 ">
                    <div class="banner banner-sqr banner-">
                      <div class="banner-bg" style="background-image:url(img/hotel-page/slider/13.jpg);"></div>
                      <a class="banner-link" href="img/hotel-page/slider/13.jpg"></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 ">
                <div class="theme-item-page-overview _mb-20 _mt-mob-20 _c-w">
                  <div class="theme-item-page-overview-rate">
                    <p class="theme-item-page-overview-rate-subtitle">
                      <b>9.5</b>out of 10
                    </p>
                    <h3 class="theme-item-page-overview-rate-title">Excellent</h3>
                    <p class="theme-item-page-overview-rate-count">Based on 1470 reviews</p>
                  </div>
                ...
                <div class="theme-item-page-desc _c-w">
              ...
              <div class="tabbable">
                <ul class="nav nav-tabs nav-white nav-no-br nav-sqr nav-mob-inline" role="tablist">
                  <li class="active" role="presentation">
                    <a class="_ph-30" aria-controls="HotelPageTabs-1" role="tab" data-toggle="tab" href="#HotelPageTabs-1">Rooms</a>
                  </li>
                  <li role="presentation">
                    <a class="_ph-30" aria-controls="HotelPageTabs-2" role="tab" data-toggle="tab" href="#HotelPageTabs-2">Details</a>
                  </li>
                  <li role="presentation">
                    <a class="_ph-30" aria-controls="HotelPageTabs-3" role="tab" data-toggle="tab" href="#HotelPageTabs-3">Map</a>
                  </li>
                  <li role="presentation">
                    <a class="_ph-30" aria-controls="HotelPageTabs-4" role="tab" data-toggle="tab" href="#HotelPageTabs-4">Reviews</a>
                  </li>
                  <li role="presentation">
                    <a class="_ph-30" aria-controls="HotelPageTabs-5" role="tab" data-toggle="tab" href="#HotelPageTabs-5">Facilities</a>
                  </li>
                </ul>
                        ...
                        <tbody>
                          <tr>
                            <td class="theme-item-page-rooms-table-type">
                              <h5 class="theme-item-page-rooms-table-type-title">Standart King Room</h5>
                              <img class="theme-item-page-rooms-table-type-img" src="img/hotel-page/rooms/1.jpg" alt="Image Alternative text" title="Image Title"/>
                            ...
                            <td class="theme-item-page-rooms-table-price">
                              <div>
                                <div class="theme-item-page-rooms-table-price-night">
                                  ...
                                  <p class="theme-item-page-rooms-table-price-night-amount">$97</p>
                                </div>
                                <div class="theme-item-page-rooms-table-price-total">
                                  <p class="theme-item-page-rooms-table-price-sign">Total price
                                    <br/>for 5 nights
                                  </p>
                                  <p class="theme-item-page-rooms-table-price-total-amount">$485</p>
                                </div>
                              </div>
                          ...
                          <tr>
                            <td class="theme-item-page-rooms-table-type">
                              ...
                              <img class="theme-item-page-rooms-table-type-img" src="img/hotel-page/rooms/2.jpg" alt="Image Alternative text" title="Image Title"/>
                              <ul class="theme-item-page-rooms-table-type-feature-list">
                                <li>
                                  <i class="fa fa-bed theme-item-page-rooms-table-type-feature-list-icon"></i>1 King bed
                                </li>
                          ...
                          <tr>
                            <td class="theme-item-page-rooms-table-type">
                              ...
                              <img class="theme-item-page-rooms-table-type-img" src="img/hotel-page/rooms/3.jpg" alt="Image Alternative text" title="Image Title"/>
                              <ul class="theme-item-page-rooms-table-type-feature-list">
                                <li>
                                  <i class="fa fa-bed theme-item-page-rooms-table-type-feature-list-icon"></i>1 King bed
                                </li>
                          ...
                          <tr>
                            <td class="theme-item-page-rooms-table-type">
                              ...
                              <img class="theme-item-page-rooms-table-type-img" src="img/hotel-page/rooms/4.jpg" alt="Image Alternative text" title="Image Title"/>
                              <ul class="theme-item-page-rooms-table-type-feature-list">
                                <li>
                          ...
                          <tr>
                            <td class="theme-item-page-rooms-table-type">
                              ...
                              <img class="theme-item-page-rooms-table-type-img" src="img/hotel-page/rooms/5.jpg" alt="Image Alternative text" title="Image Title"/>
                              <ul class="theme-item-page-rooms-table-type-feature-list">
                                <li>
                                  <i class="fa fa-bed theme-item-page-rooms-table-type-feature-list-icon"></i>2 King beds
                                </li>
                                ...
                                <div class="col-md-6 ">
                                  <div class="theme-reviews-score-item">
                                    <div class="theme-reviews-score-item-header">
                                      ...
                                      <p class="theme-reviews-score-item-num">7.4</p>
                                    </div>
                                  ...
                                  <div class="theme-reviews-score-item">
                                    <div class="theme-reviews-score-item-header">
                                      ...
                                      <p class="theme-reviews-score-item-num">7.2</p>
                                    </div>
                                    <div class="theme-reviews-score-item-bar">
                                  ...
                                  <div class="theme-reviews-score-item">
                                    <div class="theme-reviews-score-item-header">
                                      ...
                                      <p class="theme-reviews-score-item-num">9.8</p>
                                    </div>
                                    <div class="theme-reviews-score-item-bar">
                                  ...
                                  <div class="theme-reviews-score-item">
                                    <div class="theme-reviews-score-item-header">
                                      ...
                                      <p class="theme-reviews-score-item-num">5.5</p>
                                    </div>
                                    <div class="theme-reviews-score-item-bar">
                                ...
                                <div class="col-md-6 ">
                                  <div class="theme-reviews-score-item">
                                    <div class="theme-reviews-score-item-header">
                                      ...
                                      <p class="theme-reviews-score-item-num">5.7</p>
                                    </div>
                                    <div class="theme-reviews-score-item-bar">
                                  ...
                                  <div class="theme-reviews-score-item">
                                    <div class="theme-reviews-score-item-header">
                                      ...
                                      <p class="theme-reviews-score-item-num">10</p>
                                    </div>
                                    <div class="theme-reviews-score-item-bar">
                                  ...
                                  <div class="theme-reviews-score-item">
                                    <div class="theme-reviews-score-item-header">
                                      ...
                                      <p class="theme-reviews-score-item-num">8.1</p>
                                    </div>
                                    <div class="theme-reviews-score-item-bar">
                                  ...
                                  <div class="theme-reviews-score-item">
                                    <div class="theme-reviews-score-item-header">
                                      ...
                                      <p class="theme-reviews-score-item-num">9.0</p>
                                    </div>
                                    <div class="theme-reviews-score-item-bar">
                      ...
                      <div class="theme-reviews-list">
                          ...
                          <div class="row" data-gutter="10">
                            <div class="col-md-3 ">
                              <div class="theme-reviews-item-info">
                                <img class="theme-reviews-item-avatar" src="img/gustavo_henrique_para_premier_models_mgt_70x70.jpg" alt="Image Alternative text" title="Image Title"/>
                            ...
                            <div class="col-md-9 ">
                              ...
                              <div class="theme-reviews-item-body">
                                <p class="theme-reviews-item-text">Molestie parturient convallis tristique arcu nisi etiam sem posuere venenatis ipsum eleifend ullamcorper venenatis primis cum nibh nibh ante venenatis condimentum aptent lacinia ante pulvinar sociis platea nec scelerisque tempor</p>
                              </div>
                            </div>
                          </div>
                        </article>
                        <article class="theme-reviews-item">
                          <div class="row" data-gutter="10">
                            <div class="col-md-3 ">
                              <div class="theme-reviews-item-info">
                                <img class="theme-reviews-item-avatar" src="img/me_with_the_uke_70x70.jpg" alt="Image Alternative text" title="Image Title"/>
                                <p class="theme-reviews-item-date">Reviewed Mon, Jun 18</p>
                                <p class="theme-reviews-item-author">by Alison Mackenzie</p>
                              </div>
                            </div>
                            <div class="col-md-9 ">
                              <div class="theme-reviews-rating">
                                <div class="theme-reviews-rating-header">
                                  <span class="theme-reviews-rating-num">9.1</span>
                                  <span class="theme-reviews-rating-title">Excellent</span>
                                </div>
                                <div class="theme-reviews-rating-bar">
                              ...
                              <div class="theme-reviews-item-body">
                                <p class="theme-reviews-item-text">Varius lectus viverra molestie sodales massa varius velit viverra quisque faucibus id morbi imperdiet urna ultricies at mi et suscipit dictumst ante platea neque pellentesque duis nam auctor nunc dolor senectus natoque ornare sed</p>
                              </div>
                            </div>
                          </div>
                        </article>
                        <article class="theme-reviews-item">
                          <div class="row" data-gutter="10">
                            <div class="col-md-3 ">
                              <div class="theme-reviews-item-info">
                                <img class="theme-reviews-item-avatar" src="img/chiara_70x70.jpg" alt="Image Alternative text" title="Image Title"/>
                                <p class="theme-reviews-item-date">Reviewed Fri, Jun 15</p>
                                <p class="theme-reviews-item-author">by Richard Jones</p>
                              </div>
                            </div>
                            <div class="col-md-9 ">
                              <div class="theme-reviews-rating">
                              ...
                              <div class="theme-reviews-item-body">
                                <p class="theme-reviews-item-text">Sociosqu fames himenaeos facilisis non dis at facilisis nascetur eget ultricies taciti ligula auctor lectus montes interdum auctor fermentum fringilla habitasse felis semper praesent vehicula massa tristique curabitur sollicitudin tortor lobortis platea donec sodales volutpat senectus aliquet arcu consequat nisl euismod ante lorem quam consequat ultrices facilisi molestie</p>
                              </div>
                            </div>
                          </div>
                        </article>
          ...
          <div class="col-md-3 ">
            <div class="sticky-col">
              <div class="theme-search-area _p-20 _bg-p _mb-10 _br-3 theme-search-area-white theme-search-area-vert">
                <div class="theme-search-area-header _mb-20 theme-search-area-header-sm">
                  <h1 class="theme-search-area-title">Change Dates</h1>
                  <p class="theme-search-area-subtitle">Volutpat nostra tellus habitant ut</p>
                </div>
                <div class="theme-search-area-form">
                  ...
                  <button class="theme-search-area-submit _mt-0 theme-search-area-submit-sm theme-search-area-submit-no-border theme-search-area-submit-curved">Change</button>
                </div>
              </div>
          ...
          <div class="col-md-3">
            <div class="theme-footer-section theme-footer-">
              ...
              <div class="theme-footer-brand-text">
                <p>Placerat at tempus dis vitae aliquam amet tellus malesuada pulvinar augue habitant primis tortor imperdiet</p>
                <p>Sapien adipiscing volutpat bibendum auctor lobortis sociis dis imperdiet convallis proin id purus nisl primis</p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
...
<!-- Mirrored from remtsoy.com/tf_templates/tf-bookify-demo/hotel-page-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Jan 2019 08:10:28 GMT -->
</html>