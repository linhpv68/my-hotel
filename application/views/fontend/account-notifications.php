...
<!-- Mirrored from remtsoy.com/tf_templates/tf-bookify-demo/account-notifications.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Jan 2019 08:23:24 GMT -->
<head>
    <title>Travel Mate - Account notifications</title>
    <meta charset="UTF-8"/>
          ...
          <div class="col-md-3">
            <div class="theme-footer-section theme-footer-">
              ...
              <div class="theme-footer-brand-text">
                <p>Duis nisi torquent consectetur morbi tellus natoque sagittis interdum cubilia blandit fermentum integer curabitur blandit</p>
                <p>Platea tortor elementum aptent sit habitant turpis proin torquent fringilla dapibus aliquam platea imperdiet maecenas</p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
