					...
					<div class="row">
						<div class="col-xl-12">
							<div class="breadcrumb-holder">
								<h1 class="main-title float-left">Thêm mới Khách sạn</h1>
								...
								<div class="card-body">
									...
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
										<div class="card mb-3">
											...
											<div class="card-body">
												<!--<form method="post" action="http://vntrip.com/index.php/Hotel_controller/add_hotel">-->
												<form method="post" action="http://vntrip.com/index.php/Hotel_controller/add_img" enctype="multipart/form-data"
												 <div class="form-group">
													<label>Tên Khách Sạn:</label>
													<input name="tenKS" type="text" class="form-control" id="tenKS">
													<label>Địa chỉ:</label>
													<input name="diachi_phuong" type="text" class="form-control" id="diachi_phuong" placeholder="Đường">
													<br>
													<input name="diachi_quan" type="text" class="form-control" id="diachi_quan" placeholder="Quận">
													<br>
													<label for="example4">
														Chọn Thành Phố:
													</label>
													<select class="form-control select2" name="diachi_idThanhPho" id="diachi_idThanhPho">
														<optgroup>
															...
															<option value="<?= $thanhpho['idThanhPho'] ?>">
																<?= $thanhpho['TenTP'] ?>
															</option>
															<?php endforeach; ?>
														<optgroup>
													...
													<input name="GiaPhongTB" type="number" class="form-control" id="GiaPhongTB">
											...
											<!-- <a href="http://vntrip.com/index.php/Room_controller/add">Thêm Phòng</a>-->
										</div>
									</div><!-- end card-->
								</div>
							</div>
