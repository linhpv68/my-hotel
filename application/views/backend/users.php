                                        ...
                                        <?php foreach ($list_users as $list_user): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal fade custom-modal" tabindex="-1" role="dialog"
                                                         aria-hidden="true" id="edit_user">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">

                                                                <form class="theme-login-form" method="post" action="add-user" enctype="multipart/form-data" accept-charset="utf-8">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                <div class="form-group">
                                                                                    <label>Tên tài khoản:</label>
                                                                                    <input class="form-control" name="username" type="text" required  value="<?=$list_user['username']?>"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                <div class="form-group">
                                                                                    <label>Ngày Sinh:</label>
                                                                                    <input class="form-control" name="birthday" type="date" data-date="" data-date-format="DD/MM/YYYY">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="form-group">
                                                                                    <label>Số Điện thoại</label>
                                                                                    <input name="numberphone" class="form-control" type="number" placeholder="Số điện thoại" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
